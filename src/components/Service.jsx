...
const treatments = [
  // 💉 AESTHETIC INJECTABLES
  {
    ...
    description:
      "Enhance your natural beauty with our expert injectable treatments. From subtle anti-wrinkle solutions to dermal fillers that restore youthful volume — every treatment is tailored for balance, harmony, and confidence.",
    badges: [
      { icon: <Clock className="h-3 w-3 mr-1" />, text: "30–60 mins" },
      { icon: <Sparkles className="h-3 w-3 mr-1" />, text: "Rejuvenation & Refinement" },
    ],
    list: [
      "Anti-Wrinkle Injections – smooth fine lines & refresh your look",
      "Dermal Fillers – restore volume to lips, cheeks & jawline",
      "Skin Boosters – deeply hydrate for a youthful glow",
      "Consultations – bespoke treatment planning for your goals",
    ],
  },
  ...
  // ⚡ BODY CONTOURING & SCULPTING
  {
    ...
    description:
      "Define, tone, and smooth your silhouette with our advanced contouring treatments. Non-invasive technologies that help reduce stubborn areas and tighten skin — leaving you feeling confident and refined.",
    badges: [
      { icon: <Clock className="h-3 w-3 mr-1" />, text: "45–90 mins" },
      { icon: <Sparkles className="h-3 w-3 mr-1" />, text: "Sculpt & Firm" },
    ],
    list: [
      "Fat Dissolving Injections – target & contour specific areas",
      "Radio Frequency Skin Tightening – lift & firm the skin",
      "Cavitation Therapy – smooth cellulite & enhance tone",
      "Personalised Body Plans – tailored to your unique goals",
    ],
  },
];
